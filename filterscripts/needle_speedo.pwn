...
public Speedo()
{
	...
	foreach(new i : Player)
	{
		...
		speed = GetVehicleSpeed(GetPlayerVehicleID(i));
  		...
  		PlayerTextDrawSetPreviewRot(i, Speedo_Needle[i], 0.000000, CalculateSpeedRotation(135.0, 270.0, speed, 220.0), 0.000000, 2.000000);
